import { Alert, AlertTitle, Box, CircularProgress, Fade, FormControl, Modal, TextField, Typography } from '@mui/material'
...
export const DyslexiaModal = ({ open, handleClose }) => {
    ...
    return (
        <Modal open={open} onClose={closeModel} aria-labelledby="Dyslexia" aria-describedby="Dyslexia Prediction - Accept Image" >
            {spinner ?
                <Box sx={style}>
                        {/* <CircularProgress color="warning" /> */}
                        <ProgressBar setCompleted={setSpinner} />
                </Box> :
                (prediction === null) ? <Box sx={style}>
